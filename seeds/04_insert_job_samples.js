  ...
  return Promise.all([
      knex('user_account').insert([
          ...
          .then(function(result) {
              return knex('parent_profile').insert([
                  ...
                  .then(function(result) {
                      return knex('job').insert([
                          { client_id: 1, open: true, district_id: 1, location: 'Pacific Coffee', student_level_id: 1, tuition_fee: "$255/hr", num_of_student: 1, tutor_academic_id: 1, tutor_sex: 'F', times_per_week: '1 hrs', duration: '1 year', lesson_time: 'Monday 10:00am-11:00am', hotline: '9000 0001', remark: 'the tutor should be nice'},
                          { client_id: 2, open: true, district_id: 2, location: 'KFC', student_level_id: 2, tuition_fee: "$230/hr", num_of_student: 2, tutor_academic_id: 2, tutor_sex: 'M', times_per_week: '1.5 hrs', duration: '2 years', lesson_time: 'Tuesday 11:00am-12:30pm', hotline: '9000 0002', remark: 'want a patient tutor'},
                          { client_id: 3, open: true, district_id: 3, location: 'at home', student_level_id: 3, tuition_fee: "$299/hr", num_of_student: 3, tutor_academic_id: 3, tutor_sex: 'O', times_per_week: '2 hrs', duration: '3 years', lesson_time: 'Wednesday 9:00am-11:00am', hotline: '9000 0003', remark: 'need to be patient'},
                          { client_id: 4, open: true, district_id: 4, location: 'Library', student_level_id: 4, tuition_fee: "$211/hr", num_of_student: 4, tutor_academic_id: 4, tutor_sex: 'F', times_per_week: '2.5 hrs', duration: '4 years', lesson_time: 'Thursday 9:00am-11:30am', hotline: '9000 0004', remark: 'the tutor should be nice'},
                          { client_id: 5, open: true, district_id: 5, location: 'Study Room', student_level_id: 5, tuition_fee: "$260/hr", num_of_student: 5, tutor_academic_id: 5, tutor_sex: 'M', times_per_week: '3 hrs', duration: '5 years', lesson_time: 'Friday 10:00am-1:00pm', hotline: '9000 0005', remark: 'the tutor should be kind'},
                          { client_id: 6, open: true, district_id: 6, location: 'at home', student_level_id: 6, tuition_fee: "$300/hr", num_of_student: 1, tutor_academic_id: 6, tutor_sex: 'O', times_per_week: '3.5 hrs', duration: '6 years', lesson_time: 'Saturday 10:00am-1:30pm', hotline: '9000 0006', remark: 'the tutor should be a nice person'},
                          { client_id: 7, open: true, district_id: 7, location: 'McCafe', student_level_id: 7, tuition_fee: "$400/hr", num_of_student: 2, tutor_academic_id: 7, tutor_sex: 'F', times_per_week: '4 hrs', duration: '1.5 years', lesson_time: 'Sunday 10:00am-2:00pm', hotline: '9000 0007', remark: 'the tutor should be a kind person'},
                          { client_id: 8, open: true, district_id: 8, location: 'SUBWAY', student_level_id: 8, tuition_fee: "$200/hr", num_of_student: 3, tutor_academic_id: 1, tutor_sex: 'M', times_per_week: '4.5 hrs', duration: '2.5 years', lesson_time: 'Sunday 10:00am-2:30pm', hotline: '9000 0008', remark: 'the tutor should be patient'},
                          { client_id: 9, open: true, district_id: 9, location: 'McCafe', student_level_id: 9, tuition_fee: "$265/hr", num_of_student: 4, tutor_academic_id: 2, tutor_sex: 'O', times_per_week: '5 hrs', duration: '3.5 years', lesson_time: 'Saturday, Sunday 10:00am-12:30pm', hotline: '9000 0009', remark: 'the tutor should be a patient guy'},
                          { client_id: 10, open: true, district_id: 10, location: 'SUBWAY', student_level_id: 10, tuition_fee: "$275/hr", num_of_student: 5, tutor_academic_id: 3, tutor_sex: 'F', times_per_week: '5.5 hrs', duration: '4.5 years', lesson_time: 'Monday, Tuesday 10:00am-12:45pm', hotline: '9000 0010', remark: 'the tutor should be nice'},
                          { client_id: 11, open: true, district_id: 11, location: 'Pacific Coffee', student_level_id: 11, tuition_fee: "$285/hr", num_of_student: 1, tutor_academic_id: 4, tutor_sex: 'M', times_per_week: '6 hrs', duration: '5.5 years', lesson_time: 'Tuesday, Wednesday 10:00am-1:00pm', hotline: '9000 0011', remark: 'the tutor should be a nice guy'},
                          { client_id: 12, open: true, district_id: 12, location: 'KFC', student_level_id: 12, tuition_fee: "$295/hr", num_of_student: 2, tutor_academic_id: 5, tutor_sex: 'O', times_per_week: '6.5 hrs', duration: 'until DSE', lesson_time: 'Wednesday, Thursday 10:00am-1:15pm', hotline: '9000 0012', remark: 'the tutor should be kind'},
                          { client_id: 13, open: true, district_id: 13, location: 'Study Room', student_level_id: 1, tuition_fee: "$215/hr", num_of_student: 3, tutor_academic_id: 6, tutor_sex: 'F', times_per_week: '7 hrs', duration: '1 year', lesson_time: 'Thursday, Friday 10:00am-1:30pm', hotline: '9000 0013', remark: 'the tutor should be patient'},
                          { client_id: 14, open: true, district_id: 14, location: 'Library', student_level_id: 2, tuition_fee: "$225/hr", num_of_student: 4, tutor_academic_id: 7, tutor_sex: 'M', times_per_week: '7.5 hrs', duration: 'until DSE', lesson_time: 'Friday, Saturday 10:00am-1:45pm', hotline: '9000 0014', remark: 'the tutor should be kind'},
                          { client_id: 15, open: true, district_id: 15, location: 'McDonald\'s', student_level_id: 3, tuition_fee: "$235/hr", num_of_student: 5, tutor_academic_id: 1, tutor_sex: 'O', times_per_week: '8 hrs', duration: '1 year', lesson_time: 'Monday, Wednesday, Friday, Saturday 10:30am-12:30pm', hotline: '9000 0015', remark: 'want a nice tutor'},
                          { client_id: 16, open: true, district_id: 16, location: 'Starbucks', student_level_id: 4, tuition_fee: "$245/hr", num_of_student: 1, tutor_academic_id: 2, tutor_sex: 'F', times_per_week: '6 hrs', duration: 'until graduation', lesson_time: 'Tuesday, Thursday, Saturday 9:00am-11:00am', hotline: '9000 0016', remark: 'want a kind tutor'},
                          { client_id: 1, open: true, district_id: 17, location: 'McDonald\'s', student_level_id: 5, tuition_fee: "$199/hr", num_of_student: 2, tutor_academic_id: 3, tutor_sex: 'M', times_per_week: '6 hrs', duration: '1 year', lesson_time: 'Wednesday, Friday, Sunday 1:00pm-3:00pm', hotline: '9000 0017', remark: 'want a nice tutor'},
                          { client_id: 2, open: true, district_id: 18, location: 'Starbucks', student_level_id: 6, tuition_fee: "$399/hr", num_of_student: 3, tutor_academic_id: 4, tutor_sex: 'O', times_per_week: '6 hrs', duration: 'until graduation', lesson_time: 'Friday, Saturday, Sunday 3:00pm-5:00pm', hotline: '9000 0018', remark: 'want a patient tutor'}
                      ])
                          .returning("*")
                          .then(function(result) {
                              return knex('job_subject').insert([
                                  ...
                                  {job_id: 17, subject_id: 17},
                                  {job_id: 18, subject_id: 18}
                              ])
                          })
                  })
          }),
      knex('user_account').insert([
          ...
          .returning("*")
          .then(function(result) {
              return knex('tutor_profile').insert([
